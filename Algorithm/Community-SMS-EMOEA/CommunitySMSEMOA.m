function CommunitySMSEMOA(Global)
% <algorithm> <W> 
...
%     
    for i = 1:noOfParts
        ...
        Population = Community_optimiseBySMSEMOA(Global, Population, 1000, false);
        Global.NotTermination(Population); 
    end
    ...
    while Global.evaluated < Global.evaluation
        ...
        for c = 1:size(xPrimeList,2)
            ...
            for indexgroups = 1:length(groups)+1
                ...
                DecomposePopulation = Community_optimiseBySMSEMOA(GlobalDummy, DecomposePopulation, t1-transformedProblemPopulationSize, true);
