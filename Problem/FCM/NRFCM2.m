...
% No.   Name                              Samples Features Classes
    ...
    methods
        ...
        function obj = NRFCM2()
            ...
            load(fullfile(fileparts(CallStack(1).file),'Dataset_FCMA_1.mat'),'DatasetA');
%             Data = Dataset.(str{dataNo});
            obj.TrainIn     = DatasetA.(str{dataNo});
            load(fullfile(fileparts(CallStack(1).file),'Dataset_FCMY_1.mat'),'Datasety');
